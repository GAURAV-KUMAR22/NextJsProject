...
async function getStaticProps() {
    ...
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://choudharygaurav884:GZa1ZkXc4eVvtiYE@nextjs.4w2dl.mongodb.net/?retryWrites=true&w=majority&appName=NEXTJS");
    const db = client.db();
